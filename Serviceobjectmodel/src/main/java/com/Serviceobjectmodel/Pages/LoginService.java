...
public class LoginService {
	...
	public LoginService(WebDriver driver) // giving constructor to pass driver value to findBy
	{
		...
		PageFactory.initElements(driver, this); // Interview question -page factoryde akathe method aanu initElements
												// .frindby de driverlekk webdriver driver pass cheyyanam ivde blue and
												// brown drivers aanu rand drivers und
