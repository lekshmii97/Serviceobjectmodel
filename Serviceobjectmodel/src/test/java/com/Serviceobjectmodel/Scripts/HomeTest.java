...
public class HomeTest extends TestBaseService {
	...
	@Test(priority = 9, description = "verify the checkbox is selectable in column", groups = {"smoke" }, retryAnalyzer = com.Serviceobjectmodel.Listeners.RetryAnalyzer.class)
	...
	@Test(priority = 10, description = "verify the page is move back to clientpage", groups = {"smoke" }, retryAnalyzer = com.Serviceobjectmodel.Listeners.RetryAnalyzer.class)
